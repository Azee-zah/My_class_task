...
enrollment1 = input("Are you enrolled as a full-time or part-time? ")
enrollment2 = input("Are you an undergraduate or a graduate? ")
other_scholarships = input("Are you a benificiary of any other form of scholarship: ")
academic_qualifications = input("how many distinctions do you have in your relevant subjects: ")

elegibility = (citizenship == "Nigerian" or "nigerian" or "NIGERIAN") and (enrollment1 == "full-time") and (enrollment2 == "undergraduate") and (other_scholarships == "No") and (academic_qualifications == 5)
print(f"Nationality: {citizenship}\nEnrollment: {enrollment1}\nEducation_level: {enrollment2}\nother_benefits: {other_scholarships}\nAcademic_qualification: {academic_qualifications}\nEligible: {elegibility}")